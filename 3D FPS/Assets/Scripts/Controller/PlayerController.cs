...
public class PlayerController : MonoBehaviour
{
    ...
    [Tooltip("Speed at which the player rotates to look left and right, calculated in degrees")]
    ...
    private void SetupCharacterController()
    {
        ...
        if (controller == null)
        {
            Debug.LogError("The player controller script does not have a character controller on the game object");
        }
    }
